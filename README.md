...
│
├── images/
│ └── logo.png # Logo công ty (thêm vào)
│
└── js/
├── app.js # Xử lý sự kiện menu
├── renderer.js # Render nội dung theo menu
│
└── data/
├── init.js # Khởi tạo biến toàn cục
├── footer.js # Footer tags
│
├── environment/
│ ├── climate.js # Biến đổi khí hậu
│ ├── ghg.js # Khí nhà kính
│ ├── modeling.js # Mô hình hóa
│ └── gisdb.js # GIS & CSDL
│
├── society/
│ └── society.js # Xã hội
